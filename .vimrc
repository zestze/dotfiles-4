...
"set tabstop=4
"NOTE: tabstop changes the width of the TAB character

"always replace TAB w 8 spaces, except for make files 
"set expandtab
"autocmd FileType make setlocal noexpandtab
"NOTE: changes what happens whan <TAB> is pressed. If set, softtabstop amount
"of space characters are inserted.
